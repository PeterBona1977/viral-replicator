...
import { X, Terminal, Target, Zap, BookOpen, ChevronRight, Activity, Globe, Sparkles, FileText, ClipboardCheck, ArrowUpRight, Search, ListChecks, Play, ShieldCheck, Code, Clock, BrainCircuit } from 'lucide-react';
      ...
      >
        ...
        <div className="p-8 border-b border-slate-800 bg-slate-900/50 backdrop-blur flex justify-between items-center shrink-0">
            <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-purple-600/10 rounded-3xl flex items-center justify-center border border-purple-500/20 shadow-inner">
                    <BrainCircuit className="text-purple-400" size={32} />
                </div>
                <div>
                    <h2 className="text-2xl font-black text-white uppercase tracking-tight">Gemini Neural Audit</h2>
                    <div className="flex items-center gap-2 mt-1">
                        <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.4em]">Engine: Gemini-3-Pro-Research.v2</p>
        ...
        <div className="flex-1 flex overflow-hidden">
            ...
            <div className="w-24 md:w-72 border-r border-slate-800 bg-slate-950/20 flex flex-col p-6 gap-4 shrink-0">
                <button 
                  ...
                  className={`flex items-center gap-4 p-5 rounded-2xl transition-all ${activeTab === 'log' ? 'bg-purple-600/20 text-purple-400 border border-purple-500/30 shadow-lg' : 'text-slate-500 hover:bg-slate-800'}`}
                >
                    <Terminal size={24} />
            ...
            <div className="flex-1 overflow-y-auto p-12 no-scrollbar bg-slate-900/20">
                {activeTab === 'log' && (
                    <div className="space-y-10 animate-in slide-in-from-right-8 duration-500">
                        <div className="space-y-4">
                            <h4 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] flex items-center gap-2"><Search size={14} /> Gemini Research Trace</h4>
                            <div className="bg-black/80 p-10 rounded-[3rem] border border-white/5 font-mono text-[12px] leading-relaxed space-y-5 shadow-2xl">
                                {audit.operationLog.map((log, i) => (
                                    <div key={i} className="flex gap-6 group">
                                        <span className="text-slate-800 font-bold group-hover:text-purple-500 transition-colors">[{new Date().getHours()}:{i+12}:{i+15}]</span>
                                        <span className="text-purple-500 font-bold">NEURAL:</span>
                        ...
                        <div className="p-10 bg-slate-900 border border-slate-800 rounded-[2.5rem] relative overflow-hidden group">
                            <BrainCircuit className="absolute -bottom-8 -right-8 text-white/5 w-48 h-48 group-hover:scale-110 transition-transform duration-1000" />
                            <h4 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-6 flex items-center gap-2"><Globe size={14} /> Global Resonance</h4>
                ...
                {activeTab === 'guide' && (
                    <div className="space-y-10 animate-in slide-in-from-right-8 duration-500">
                        <div className="flex justify-between items-end">
                             <div>
                                <h3 className="text-4xl font-black text-white uppercase tracking-tighter mb-2">Neural Playbook</h3>
                        ...
                        <div className="grid gap-8">
                             <div className="group bg-slate-950 p-10 rounded-[3rem] border border-slate-800 hover:border-purple-500/30 transition-all relative">
                                ...
                                <h4 className="text-[12px] font-black text-purple-400 uppercase tracking-[0.2em] mb-4">The Hook</h4>
                             ...
                             <div className="group bg-slate-950 p-10 rounded-[3rem] border border-slate-800 hover:border-cyan-500/30 transition-all relative">
                                ...
                                <h4 className="text-[12px] font-black text-cyan-400 uppercase tracking-[0.2em] mb-4">Sonic Strategy</h4>
                        ...
                        <div className="pt-6">
                            ...
                            >
                                <Play size={24} fill="currentColor" /> Initialize Production
                            </button>
                        </div>
                    </div>
                )}
                ...
                {activeTab === 'strategy' && (
                    <div className="space-y-12 animate-in slide-in-from-right-8 duration-500">
                        <div className="bg-purple-600/10 border border-purple-500/20 p-12 rounded-[4rem] relative overflow-hidden">
                            <Sparkles className="absolute top-8 right-8 text-purple-500 opacity-20" size={80} />
                            <h4 className="text-[10px] font-black text-purple-400 uppercase tracking-[0.4em] mb-8">Intelligence Summary</h4>
